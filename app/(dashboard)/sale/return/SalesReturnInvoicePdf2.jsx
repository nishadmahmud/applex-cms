...
function CustomerInfo({ invoice }) {
  ...
  const customer = invoice?.customers || invoice?.sales?.customer_name || {};

  const returnId = invoice?.return_id || "-";
  const saleInvoiceId = invoice?.sales?.custom_invoice_id ||
    invoice?.sales?.invoice_id ||
    invoice?.invoice_id ||
    "-";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleRow}>
        <Text style={styles.title}>SALES RETURN INVOICE</Text>
      </View>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.colLeft}>
          ...
          <Text style={styles.valueBold}>
            {customer?.name || invoice?.sales?.customer_name || "-"}
          </Text>
...
export default function SaleReturnInvoicePdf2({
