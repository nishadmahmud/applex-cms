...
function Header({ user, fallbackUserInfo, filters, apiRange }) {
  ...
  return (
    <>
      <View style={styles.headerWrap}>
        ...
        <View style={styles.rightInfo}>
          <Text style={styles.rightLine}>
            Report: Purchase Register Details
          </Text>
      ...
      <Text style={styles.title}>Purchase Register Details Report</Text>
    </>
  );
}

export default function PurchaseRegisterDetailsReportPDF({
  rows = [],
  total = 0,
  filters,
  apiRange,
      ...
      <Page size="A4" orientation="portrait" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.th, styles.vendorCol]}>
          ...
          {rows.map((r, i) => (
            <View style={styles.row} key={`r-${i}`}>
              ...
              <View style={[styles.td, styles.vendorCol]}>
