...
import { usePaymentTypeSaveMutation } from "@/app/store/api/paymentApi"
import { toast } from "sonner"


export default function CreateInterface({ onClose }) {
  ...
  const [paymentTypeSave, { isLoading }] = usePaymentTypeSaveMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await paymentTypeSave(payload).unwrap();
      if (response.success) {
