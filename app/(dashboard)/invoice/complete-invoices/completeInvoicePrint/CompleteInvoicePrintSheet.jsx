...
import CompleteInvoiceLabel from "./CompleteInvoiceLabel";

const CompleteInvoicePrintSheet = forwardRef(({ invoices, session }, ref) => (
...
export default CompleteInvoicePrintSheet;
