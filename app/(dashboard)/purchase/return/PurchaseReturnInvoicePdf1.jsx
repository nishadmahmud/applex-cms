...
function Header({
  ...
  const customerName = purchase?.vendor.name || "N/A";
  const customerPhone = purchase?.vendor.mobile_number || "N/A";
  const paymentMode = purchase?.pay_mode || "N/A";
...
// ----- MAIN DOCUMENT -----
export default function PurchaseReturnInvoicePdf1({
  orderId,
  qrDataUrl,
  invoice,
  user,
